...
public class MatrixAddRowColDiag {
	public static void main(String[] args) {
		...
		int size = in.nextInt();
      	...
      	int result = 
          	diagSum 
            + getRowSumExcludingFirstAndLast(0, mat)
            + getColSumExcludingFirstAndLast(0, mat)
            + getRowSumExcludingFirstAndLast(size - 1, mat)
            + getColSumExcludingFirstAndLast(size - 1, mat);
